...
|---|---|---|
| [`Allura_Memory`](https://github.com/Allura-Ecosystem/Allura_Memory) | Governed memory and control plane: MCP/API, PostgreSQL storage, PostgreSQL graph tables, RuVector adapter, curator, policy, and audit | Public canonical product repository; owning README and AD-49/AD-50 define the active architecture; public portfolio and interactive governed-control-plane demo under `docs/portfolio/allura-agentic-framework-harness/` |
